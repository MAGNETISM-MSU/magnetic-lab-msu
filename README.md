...
2. Get some instructions from the [tutorial](https://github.com/MAGNETISM-MSU/magnetic-lab-msu/blob/master/Gnuplot/Instructions) (more info: [Gnuplot v.5.2 Manual](http://www.gnuplot.info/docs_5.2/Gnuplot_5.2.pdf))
