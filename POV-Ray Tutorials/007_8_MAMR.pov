...
sphere { <cx1,cy1,cz1> , 20 texture {pigment{ color rgb <1.1,0.47,0.14>}} finish{reflection 0.1 specular 0.8 phong 0.5 phong_size 100 diffuse 2 ambient color<0.1,0.1,0.1> brilliance 2 } rotate z*7 }
#end
...
#declare
   Ball = sphere  {
      <0,0,0>,1 scale <5,5,5>  hollow on
    pigment { rgbt 0.98 }
    interior { Glow(<0.1, 0.2, 3>*Brightness) }
     no_shadow rotate z*7 no_radiosity
      }
//---------------------------------
#declare Radius0  = 5.0;
#declare N_rev    = 3.5; //number of loops
#declare N_p_rev  = 500; //number of spheres
#declare D_p_rev  = 22; //distance between loop
...
#while (Nr< EndNr)
 object{Ball
        translate<-Radius0,Nr*D,Nr*D*0.8>
        //translate<-250,300,6>
        rotate<0,0,-Nr*360/N_p_rev> 
        translate<-270,300,20>
        rotate z*5
       }
